...
from ModelTest import TweetR, Place
...
def main():
    ...
    # 1. Query Tweets from PostgreSQL
    # 2. Text Pre-Processing
    # 3. Temporal Word Frequency Analysis
    # 4. Animate Output
